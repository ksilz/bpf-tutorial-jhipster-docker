...
import { BpfLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: BpfLoginModalComponent;
    let fixture: ComponentFixture<BpfLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [BpfLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(BpfLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(BpfLoginModalComponent);
