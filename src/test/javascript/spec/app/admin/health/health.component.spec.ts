...
import { BpfHealthCheckComponent } from 'app/admin/health/health.component';
import { BpfHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('BpfHealthCheckComponent', () => {
    let comp: BpfHealthCheckComponent;
    let fixture: ComponentFixture<BpfHealthCheckComponent>;
    let service: BpfHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [MySimpleShopTestModule],
        declarations: [BpfHealthCheckComponent]
      })
        .overrideTemplate(BpfHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(BpfHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(BpfHealthService);
    });
