...
@NgModule({
  imports: [
    ...
    MySimpleShopSharedModule.forRoot(),
    MySimpleShopCoreModule,
    MySimpleShopHomeModule,
    MySimpleShopAccountModule,
