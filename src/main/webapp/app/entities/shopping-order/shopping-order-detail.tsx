...
export interface IShoppingOrderDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const ShoppingOrderDetail = (props: IShoppingOrderDetailProps) => {
  useEffect(() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ShoppingOrderDetail);
